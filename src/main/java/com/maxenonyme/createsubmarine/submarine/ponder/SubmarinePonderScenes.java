...
public class SubmarinePonderScenes {
    ...
    public static void oxygeneDiffuser(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        scene.world().modifyBlockEntity(util.grid().at(3, 1, 4),
                com.simibubi.create.content.fluids.tank.FluidTankBlockEntity.class, be -> {
                    be.getTankInventory().fill(
                            new net.neoforged.neoforge.fluids.FluidStack(CreateSubmarine.OXYGEN.get(), 16000),
        ...
        for (int i = 0; i < 40; i++) {
            scene.effects().emitParticles(
                    ...
                    scene.effects().simpleParticleEmitter(net.minecraft.core.particles.ParticleTypes.BUBBLE,
                ...
                com.simibubi.create.content.fluids.tank.FluidTankBlockEntity.class, be -> {
                    be.getTankInventory()
                            .fill(new net.neoforged.neoforge.fluids.FluidStack(
                                    net.minecraft.world.level.material.Fluids.WATER, 16000),
                                    net.neoforged.neoforge.fluids.capability.IFluidHandler.FluidAction.EXECUTE);
                });
        ...
        for (int i = 0; i < 40; i++) {
            ...
            scene.world().modifyBlockEntity(util.grid().at(7, 1, 4),
                    com.simibubi.create.content.fluids.tank.FluidTankBlockEntity.class, be -> {
                        be.getTankInventory()
                                .fill(new net.neoforged.neoforge.fluids.FluidStack(
                                        com.maxenonyme.createsubmarine.CreateSubmarine.OXYGEN.get(), 200),
                                        net.neoforged.neoforge.fluids.capability.IFluidHandler.FluidAction.EXECUTE);
                    });
            scene.idle(2);
        }
    ...
    public static void waterThruster(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        for (int i = -9; i <= 3; i++) {
            ElementLink<WorldSectionElement> segment = scene.world().showIndependentSection(iceFloor, Direction.UP);
        ...
        ElementLink<WorldSectionElement> raft = scene.world().showIndependentSection(raftSelection, Direction.DOWN);
        scene.idle(20);
